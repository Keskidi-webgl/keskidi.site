...
class LoungePosterInteractPointConfig extends InteractPointConfigElement {
  protected _name = INTERACT_POINT_NAME.LOUNGE_POSTER
  ...
  protected _url = LoungeConfig.fullUrl + '/' + URL_OBJECT_IDENTIFIER.LOUNGE_POSTER

}

export default new LoungePosterInteractPointConfig()
