...
export default class AssetManagerInitializer extends Initializers<null, void> {
  init(): void {
    AssetsManager
      ...
      .registerGltf(GLTF_ASSET.OUTSIDE, "https://keskidi.s3.eu-west-3.amazonaws.com/medias/outside.gltf", "outside.gltf")
      .registerGltf(GLTF_ASSET.PAPER, "https://keskidi.s3.eu-west-3.amazonaws.com/medias/papier.gltf", "papier.gltf")
