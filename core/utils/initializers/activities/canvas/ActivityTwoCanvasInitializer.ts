...
export default class ActivityTwoCanvasInitializer extends ActivityCanvasInitializer<{ wordObjectCanvas: HTMLCanvasElement, activityStore: ActivityStore }, void> {
  init(): void {
