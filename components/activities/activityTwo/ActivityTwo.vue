<template>
  <div class="activity-page">
    ...
    <main class="activity-page-content">
      <div>
          <h2 class="activity-item--title">{{ activityStore.dataWord.name }}</h2>
          <div class="activity-item--info">
            <span class="activity-item--phonetic">{{ activityStore.dataWord.definition.phonetic }}</span>
            <span class="activity-item--gender">{{ activityStore.dataWord.definition.gender }}</span>
            <p class="activity-item--definition">"{{ activityStore.dataWord.definition.definition }}"</p>

          </div>


        <p class="activity-item--origin main-font">{{ activityStore.dataWord.definition.origin }}</p>

          <div class="activity-item--mediaContainer">
            <div class="activity-item--mediasWrapper" v-for="item in activityStore.dataWord.definition.medias">
